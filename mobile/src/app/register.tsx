    ...
    >
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.form}>
          ...
          <Pressable
            style={[styles.registerButton, { backgroundColor: Brand.yellow }]}
          ...
          <View style={styles.loginRow}>
            ...
            >
              <Text style={[styles.loginLink, { color: Brand.turquoise }]}>Giriş Yap</Text>
            </Pressable>
          </View>
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  loginLink: { fontSize: FontSize.sm, fontWeight: '700' },
});
